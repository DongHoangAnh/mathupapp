...
function AdaptiveTestContent() {
  ...
  if (testState.phase === 'intro') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0093c9]/10 via-white to-[#ea9c48]/10 p-6">
        <div className="max-w-4xl mx-auto">
          <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
            <CardHeader className="text-center pb-6">
              <CardTitle className="text-3xl font-bold text-[#0093c9] mb-4">
                Kiểm tra thích ứng - Toán học nâng cao
              </CardTitle>
              <div className="flex justify-center mb-6">
                <Brain className="h-16 w-16 text-[#0093c9]" />
              </div>
            </CardHeader>
            <CardContent className="p-8">
              <div className="space-y-6">
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center p-4 bg-[#0093c9]/10 rounded-lg border border-blue-200">
                    <Clock className="h-8 w-8 text-[#0093c9] mx-auto mb-2" />
                    <h3 className="font-semibold text-blue-800">Thích ứng</h3>
                    <p className="text-sm text-[#0093c9]">AI hỗ trợ khi cần</p>
                  </div>
                ...
                <div className="flex justify-center">
                  <Button 
                    ...
                    className="bg-gradient-to-r from-[#0093c9] to-[#ea9c48] hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 text-lg font-semibold rounded-xl shadow-lg transition-all duration-300 hover:scale-105"
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
            ...
            <CardContent className="p-8">
              {supportContent && (
                <div className="space-y-6">
                  <div className="bg-[#0093c9]/10 border border-blue-200 rounded-lg p-6">
            ...
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-8">
                  <Button 
                    onClick={() => navigate('/')}
                    className="bg-gradient-to-r from-[#0093c9] to-[#ea9c48] text-white px-6 py-3 font-semibold rounded-xl"
                  >
                    Về trang chủ
                  </Button>
                  <Button 
        ...
        <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              <Badge variant="outline" className="bg-[#0093c9]/10 text-blue-700">
          ...
          <CardContent className="p-6">
            {!showExplanation ? (
              <div className="space-y-4">
                ...
                <div className="flex justify-end mt-6">
                  <Button 
                    ...
                    className="bg-gradient-to-r from-[#0093c9] to-[#ea9c48] hover:from-blue-700 hover:to-blue-800 text-white px-6 py-3 font-semibold rounded-xl"
              ...
              <div className="space-y-4">
                ...
                {/* Explanation */}
                <div className="bg-[#0093c9]/10 border border-blue-200 rounded-lg p-4">
                ...
                <div className="flex justify-end">
                  <Button 
                    ...
                    className="bg-gradient-to-r from-[#0093c9] to-[#ea9c48] hover:from-teal-700 hover:to-blue-700 text-white px-6 py-3 font-semibold rounded-xl"

              ...
              return (
                <div key={user.id} className="text-center">
                  ...
                  <div className={`bg-${podiumColor} px-4 ${podiumHeights[user.rank - 1]} rounded-t-lg`}>
                    <div className={`text-3xl font-bold mb-1 ${isFirst ? 'text-navy' : user.rank === 2 ? 'text-gray-600' : 'text-orange-700'
                      }`}>
                      {user.rank}
                    </div>
                    <div className={`font-semibold ${isFirst ? 'text-navy' : user.rank === 2 ? 'text-gray-800' : 'text-orange-800'
                      }`}>
                      {user.name}
                    </div>
                    <div className={`text-sm ${isFirst ? 'text-navy/80' : user.rank === 2 ? 'text-gray-600' : 'text-orange-700'
                      }`}>

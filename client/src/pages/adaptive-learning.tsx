            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Select value={selectedGrade} onValueChange={(value) => setSelectedGrade(value)}>
                  ...
                  <SelectContent>
                    <SelectItem value="12">Lớp 9</SelectItem>
                    <SelectItem value="11">Lớp 8</SelectItem>
                    <SelectItem value="10">Lớp 7</SelectItem>
                    <SelectItem value="10">Lớp 6</SelectItem>
                    <SelectItem value="10">Lớp 5</SelectItem>
                    <SelectItem value="10">Lớp 4</SelectItem>
                    <SelectItem value="10">Lớp 3</SelectItem>
                    <SelectItem value="10">Lớp 2</SelectItem>
                    <SelectItem value="10">Lớp 1</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <Button 

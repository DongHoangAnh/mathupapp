...
export const mockGameShowQuestions = [
  ...
  },
  {
    ...
    level: 6,
    prize: "100.000",
    question: "Phương trình 2x - 6 = 10 có nghiệm là:",
    options: ["x = 8", "x = 2", "x = 4", "x = 16"],
    correctAnswer: "x = 8",
    difficulty: 3,
  },
  {
    ...
    level: 7,
    prize: "200.000",
    question: "Cho tam giác vuông có cạnh góc vuông là 3cm và 4cm. Cạnh huyền dài:",
    options: ["5cm", "7cm", "6cm", "8cm"],
    correctAnswer: "5cm",
    difficulty: 4,
  },
  {
    ...
    options: ["x = 2 hoặc x = 3", "x = 1 hoặc x = 6", "x = -2 hoặc x = -3", "x = 4 hoặc x = 1"],
  ...
  },
  {
    ...
    level: 10,
    prize: "5.000.000",
    question: "Đạo hàm của hàm số y = x³ + 2x là:",
    options: ["y' = 3x² + 2", "y' = 3x² + 2x", "y' = x² + 2", "y' = 3x + 2"],

...
export default function Navigation() {
  ...
  const navItems = [
    ...
    { path: "/adaptive-learning", label: "Ôn luyện", icon: Brain, view: "adaptive-learning" },
    ...
    { path: "/payment", label: "Thanh Toán", icon: Medal, view: "payment" },
  ];
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <img src="/logo.png" alt="MathUp Logo" className="h-16 w-auto" />
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="w-8 h-8 bg-gold rounded-full flex items-center justify-center">
                <Link href="/userdetail">
                  <span className="text-navy font-semibold text-sm cursor-pointer">

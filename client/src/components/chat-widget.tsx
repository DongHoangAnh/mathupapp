    ...
    <>
      ...
      {isOpen && (
        <Card className="fixed bottom-24 right-6 w-80 bg-white rounded-xl shadow-2xl border z-50">
          {/* Header */}
          <div className="bg-gradient-to-r from-[#00a8dd] to-[#f1b15b] hover:from-[#0093c9] hover:to-[#ea9c48] text-white p-4 rounded-t-xl">
          ...
          <div className="p-4 border-t">
            <div className="flex space-x-2">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-[#00a8dd] to-[#f1b15b] hover:from-[#0093c9] hover:to-[#ea9c48]"
              >
                <Send size={16} />
              </Button>
            </div>
